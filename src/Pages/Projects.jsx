    ...
    <section>
      <div className="mx-4 lg:mx-20 mt-10 lg:mt-20">
        ...
        <section className="grid lg:grid-cols-2 lg:mx-20 lg:mt-15 mx-4 mt-20">
          <div className="lg:w-1/2 lg:h-[450px] w-full h-[343px] bg-[#1A1A1A] rounded-2xl flex items-center justify-center mx-auto lg:mx-0">
        ...
        {/* project sections */}
        <section className="grid lg:grid-cols-2 lg:mx-20 lg:mt-15 mx-4 mt-20">
          <div className="lg:w-1/2 lg:h-[50px] w-full h-[343px] bg-[#1A1A1A] rounded-2xl flex items-center justify-center mx-auto lg:mx-0">
